...
resourcestring
  ...
  sByNumberAsc = 'По номерам по возрастанию';
  sByNumberDesc = 'По номерам по убыванию';
  sByNameAsc = 'По именам А-Я';
  sByNameDesc = 'По именам Я-А';
  sByResult = 'По текущим результатам';
  ...
  sFinishResultsNotEmpty = 'результаты финиша не пусты. Вы уверены что хотите сформировать стартовый протокол для данного спецучастка?';
